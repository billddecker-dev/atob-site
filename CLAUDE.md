# From A to B Entertainment — Project Context
...
- Hosted: Netlify (auto-deploys from GitHub main branch)
- Repo: github.com/billddecker-dev/atob-site
...
- Introduce Amy + Bill authentically
- Drive traffic to paid content platforms
...
## Rules
- Never use em dashes
- Keep copy warm, authentic, never clinical
- Bill handles first contact always
- No straight men, no single straight men, no men over 50